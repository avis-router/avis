...
Avis requires Java 1.5.0 later. There is no requirement to build Avis
since binaries are included with the distribution, but if you do wish
to compile Avis you will need a Java Development Kit installed. If you
don't want to build Avis, you can skip to the next section.
...
Optional:
  ...
  * Markdown 1.0.1 or later. Required to build web
    site. http://daringfireball.net/projects/markdown/

  * Rsync. Required to upload web site.

To build the router binary with Ant, change to the directory where you
...
which performs more advanced optimizations targetted at long-running
servers.
