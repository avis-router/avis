...
public abstract class Node<E>
{
   ...
   */
  public abstract E evaluate (Map<String, Object> attrs);

  /**
   * The type of result that is guaranteed to be generated by {@link
   * #evaluate(Map)}. This should be compatible with E.
   */
  public abstract Class<? extends E> evalType ();
   ...
   *         replaces this one.
   */
  public abstract Node<E> inlineConstants ();
